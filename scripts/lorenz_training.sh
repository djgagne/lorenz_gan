...
#declare -a configs=("900" )
declare -a configs=("700" "701" "702" "703" "801" "802" "803" "900")
for config in ${configs[@]}; do
    echo $config
    python -u train_lorenz_gan.py config/exp_20_stoch/lorenz_train_f_20_n_${config}_c_dense.yaml -r -g &>> lorenz_train.log
done
python -u train_lorenz_gan.py config/exp_20_stoch/lorenz_train_f_20_n_701_c_dense_l2_0.01.yaml -r -g &>> lorenz_train.log
python -u train_lorenz_gan.py config/exp_20_stoch/lorenz_train_f_20_n_701_c_dense_l2_0.0001.yaml -r -g &>> lorenz_train.log
